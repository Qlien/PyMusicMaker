...
from MoveMe.Canvas.Objects.Base.ResizableObject import ResizableObject

class SimpleBoxNode(ClonableObject, DeletableObject, SelectableObject, MovableObject, CanvasObject, ResizableObject):
    """
